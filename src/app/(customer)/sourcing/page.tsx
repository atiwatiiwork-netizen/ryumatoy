...
function SourcingRules() {
  ...
  const rules: { emoji: string; head: string; body: React.ReactNode }[] = [
    ...
    // ระบบยังไม่มีปุ่มยกเลิก/คืนเงินอัตโนมัติ (เจ้าของสั่ง 2026-07-26) — คืนเงินทำผ่านแอดมินโดยตรง
    // ข้อความจึงต้องบอกวิธีให้ชัด ไม่ใช่ปล่อยให้ลูกค้าหาปุ่มที่ไม่มี
    { emoji: '🛡️', head: 'คืนมัดจำ 100% ถ้าหาของไม่ได้', body: 'ผู้ขายไม่ส่ง / ยกเลิกรายการ — ทักแอดมินได้เลย ร้านโอนคืนให้เอง' },
