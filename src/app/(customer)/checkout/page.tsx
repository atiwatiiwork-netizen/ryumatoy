...
export default function CheckoutPage() {
  ...
  // เข้าหน้าชำระ = ดึงข้อมูลล่าสุดหนึ่งรอบ ก่อนตัดสินของหมด/ราคา (เครื่องที่เปิดค้างข้อมูลเก่า ~40 วิ)
  // ด่านจริงยังเป็น RPC จองข้างล่าง — อันนี้ทำให้จอ/ป้ายตรงความจริงเร็วขึ้น
