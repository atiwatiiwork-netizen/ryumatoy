...
const TRIGGERS: { key: string; emoji: string; name: string; target: string; note?: string }[] = [
  ...
  { key: 'points_launch', emoji: '⭐', name: 'ประกาศเปิดระบบคะแนน (บอกแต้มของแต่ละคน)', target: 'ลูกค้าที่เปิดกระดิ่ง', note: 'ยิงครั้งเดียวตอนแอดมินกด 🚀 เปิดตัวที่ /admin/points (ติ๊กเลือกได้)' },
  ...
  { key: 'auction_open', emoji: '🔨', name: 'ประมูล: ประกาศเปิดรอบ', target: 'ทุกเครื่อง', note: 'แอดมินกดเองจากปุ่ม “📣 ประกาศเปิดประมูล”' },
  { key: 'auction_outbid', emoji: '⚡', name: 'ประมูล: มีคนบิดแซง', target: 'คนที่เพิ่งถูกแซง', note: 'ยิงทันทีทุกครั้งที่มีคนบิดแซง' },
  { key: 'auction_price', emoji: '🔔', name: 'ประมูล: ราคาขยับ', target: 'คนกดกระดิ่ง + คนที่เคยบิด', note: 'เซิร์ฟเวอร์หรี่ให้ไม่ถี่กว่า 5 นาที/ห้อง กันเด้งรัวช่วงท้ายจนคนปิดกระดิ่ง' },
  { key: 'auction_soon', emoji: '⏰', name: 'ประมูล: ใกล้ปิด', target: 'คนกดกระดิ่ง + คนที่เคยบิด', note: 'แอดมินกดเองจากปุ่ม “⏰ เตือนใกล้ปิด”' },
  { key: 'auction_result', emoji: '🏆', name: 'ประมูล: ประกาศผล', target: 'ผู้ชนะ (ส่วนตัว) + คนที่ร่วมบิด', note: 'ยิงพร้อมกด “ปิด + สรุปผล”' },
];
